...
void KeyScan()
{
	...
	switch(keyout)
	{
		case 0: Key_Buff[0] = Key_Buff[0] << 1 | KEY_OUT_1; break;
		case 1: Key_Buff[1] = Key_Buff[1] << 1 | KEY_OUT_2; break;
		case 2: Key_Buff[2] = Key_Buff[2] << 1 | KEY_OUT_3; break;
		case 3: Key_Buff[3] = Key_Buff[3] << 1 | KEY_OUT_4; break;
		default: break;
	}
